...
About our data loaders:
  * We wrote custom data loaders in [imp_layers.py](https://github.com/cvzoya/visimportance/blob/master/gdi/imp_layers.py) which get invoked by the data layers (see top of train.prototxt and val.prototxt files)
